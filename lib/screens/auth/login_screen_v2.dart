          ...
          child: Column(
            ...
            children: [
              ...
              if (!compact) ...[
                ...
                const Text(
                  'One workspace. Every restaurant operation.',
                  style: TextStyle(
                    fontSize: 27,
                    fontWeight: FontWeight.w900,
                    color: _LoginScreenState.ink,
                ...
                const Text(
                  'Tables, kitchen, billing, payments, inventory, workforce, PRA, live monitoring and management controls in one secure system.',
                  style: TextStyle(
                    color: _LoginScreenState.muted,
                    fontSize: 13,
                    height: 1.5,
              ...
              Wrap(
                ...
                runSpacing: 9,
                children: chips
                    .map((e) => _FeatureChip(icon: e.$1, label: e.$2))
                    .toList(),
              ),
              if (!compact) ...[
                  ...
                  child: const Row(
                    children: [
                      Icon(
                        ...
                        color: _LoginScreenState.red,
                        size: 18,
                      ),
                      SizedBox(width: 9),
                      Expanded(
                        child: Text(
                          '3-day trial • Flexible packages • Secure cloud access',
                          style: TextStyle(
                            color: _LoginScreenState.burgundy,
                ...
                const Text(
                  'Tycoon Technologies Pvt. Ltd. • Islamabad • Call: 03060626699',
                  style: TextStyle(
...
class _LoginForm extends StatelessWidget {
          ...
          child: ConstrainedBox(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.circular(18),
                border: Border.all(color: _LoginScreenState.border),
                boxShadow: const [
                  BoxShadow(
                  ...
                  children: [
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Checkbox(
                            ...
                            activeColor: _LoginScreenState.burgundy,
                          ),
                        ),
                    ...
                    SizedBox(
                      ...
                      child: FilledButton(
                        ...
                        style: FilledButton.styleFrom(
                          backgroundColor: _LoginScreenState.burgundy,
                    ...
                    Center(
                      child: TextButton(
                        onPressed: onSignUp,
                        child: const Text(
                          'Need a restaurant account?  Create one',
                          style: TextStyle(
                            color: _LoginScreenState.muted,
                            fontSize: 11.5,
                            fontWeight: FontWeight.w600,
                    ...
                    const Center(
                      child: Text(
                        'Start with a 3-day trial, then choose your package.',
                        style: TextStyle(
                          color: Color(0xFF94A3B8),
                          fontSize: 10.5,
                        ),
  ...
  static InputDecoration _decoration(String hint, IconData icon) =>
      InputDecoration(
        hintText: hint,
