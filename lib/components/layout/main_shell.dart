              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Column(children: [
                    _QuickTopBar(currentLocation: location, accent: _accent, onChooseColor: _showColors),
...
class _QuickTopBarState extends State<_QuickTopBar> {
  ...
  void _scroll(double amount) {
    ...
    final target = (_menuController.offset + amount).clamp(0.0, _menuController.position.maxScrollExtent).toDouble();
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        IconButton(tooltip: 'Previous menu items', onPressed: () => _scroll(-360), icon: const Icon(Icons.chevron_left_rounded, size: 21, color: Color(0xFF475569))),
        Expanded(
        ...
        IconButton(tooltip: 'More menu items', onPressed: () => _scroll(360), icon: Icon(Icons.chevron_right_rounded, size: 22, color: widget.accent)),
    ...
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      ...
      builder: (_, snap) {
        ...
        return Stack(clipBehavior: Clip.none, children: [
          IconButton(tooltip: 'Notifications', onPressed: () => _show(context, visible), icon: const Icon(Icons.notifications_none_rounded, color: Color(0xFF334155), size: 20)),
          if (unread > 0)
            Positioned(
              right: 5,
              top: 5,
  ...
  void _show(BuildContext context, List<QueryDocumentSnapshot<Map<String, dynamic>>> docs) {
    showDialog(
      ...
      builder: (dialog) => Dialog(
        ...
        child: SizedBox(
          width: MediaQuery.sizeOf(dialog).width * .66,
          height: MediaQuery.sizeOf(dialog).height * .66,
          child: Column(children: [
            Padding(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 6),
                IconButton(tooltip: 'Close', onPressed: () => Navigator.pop(dialog), icon: const Icon(Icons.close_rounded)),
              ]),
            ),
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return ListTile(
                          ...
                          leading: CircleAvatar(backgroundColor: unread ? accent.withValues(alpha: .10) : const Color(0xFFF1F5F9), child: Icon(_eventIcon((d['type'] ?? '').toString()), color: unread ? accent : const Color(0xFF64748B), size: 18)),
